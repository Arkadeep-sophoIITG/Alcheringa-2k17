...
public class Informals extends AppCompatActivity {
    ...
    private void initializeData(){
        ...
        concertItem.add(new ConcertItem("Tug Of War",  R.drawable.tugofwar));
        concertItem.add(new ConcertItem("Snakes and Ladders", R.drawable.snakes));
        concertItem.add(new ConcertItem("Pen Fight", R.drawable.penfight));
        concertItem.add(new ConcertItem("Treasure Hunt", R.drawable.treasure));
        concertItem.add(new ConcertItem("Gadha Maar", R.drawable.gadhamaar));
    }
