...
public class ScavengerHunt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Drawer drawer = new DrawerBuilder()
                ...
                .build();
       ListView listView=(ListView) findViewById(R.id.list_scavenger);
        String[] listStrings = getResources().getStringArray(R.array.scavenger);
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,R.layout.module_list_item, R.id.list_item_text, listStrings);
